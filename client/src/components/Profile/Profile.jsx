...
function Profile() {
  ...
  return (
    ...
    <div>
      ...
      <button
        value="toxic"
        onClick={(e) => incrementValue(e, 'toxic')}
        type="button"
      >
        Add
      </button>
      <button
        name="toxic"
        onClick={(e) => decrementValue(e, 'toxic')}
        type="button"
      >
        Minus
      </button>
      ...
      <button onClick={(e) => incrementValue(e, 'friendly')} type="button">
        Add
      </button>
      <button onClick={(e) => decrementValue(e, 'friendly')} type="button">
        Minus
      </button>
      <h4>{charac?.teamPlayer}</h4>
      <button onClick={(e) => incrementValue(e, 'teamPlayer')} type="button">
        Add
      </button>
      <button onClick={(e) => decrementValue(e, 'teamPlayer')} type="button">
        Minus
      </button>
      <h4>{charac?.strategy}</h4>
      <button onClick={(e) => incrementValue(e, 'strategy')} type="button">
        Add
      </button>
      <button onClick={(e) => decrementValue(e, 'strategy')} type="button">
        Minus
      </button>
      <h4>{charac?.leader}</h4>
      <button onClick={(e) => incrementValue(e, 'leader')} type="button">
        Add
      </button>
      <button onClick={(e) => decrementValue(e, 'leader')} type="button">
        Minus
      </button>
    </div>
  )
